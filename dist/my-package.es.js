...
function ir() {
  if (Re)
    return j;
  Re = 1;
  var M = Oe, P = Symbol.for("react.element"), N = Symbol.for("react.fragment"), _ = Object.prototype.hasOwnProperty, D = M.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, F = { key: !0, ref: !0, __self: !0, __source: !0 };
  function S(h, l, R) {
    var d, g = {}, m = null, A = null;
    R !== void 0 && (m = "" + R), l.key !== void 0 && (m = "" + l.key), l.ref !== void 0 && (A = l.ref);
    for (d in l)
      _.call(l, d) && !F.hasOwnProperty(d) && (g[d] = l[d]);
    if (h && h.defaultProps)
      for (d in l = h.defaultProps, l)
        g[d] === void 0 && (g[d] = l[d]);
    return { $$typeof: P, type: h, key: m, ref: A, props: g, _owner: D.current };
  }
...
function ur() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === _ || e === F || De || e === D || e === R || e === d || ke || e === A || we || xe || je || typeof e == "object" && e !== null && (e.$$typeof === m || e.$$typeof === g || e.$$typeof === S || e.$$typeof === h || e.$$typeof === l || // This needs to include all possible module reference object
...
var sr = H.exports;
const lr = () => /* @__PURE__ */ sr.jsx("div", { children: "MyComponent" });
export {
  lr as MyComponent
};
